...
#define AS923_GET_PHY_PARAM()                  \
	AS923_CASE                                 \
	{                                          \
		return RegionAS923GetPhyParam(getPhy); \
	}
...
#define AS923_VERIFY()                                  \
	AS923_CASE                                          \
	{                                                   \
		return RegionAS923Verify(verify, phyAttribute); \
	}
...
#define AS923_CHAN_MASK_SET()                       \
	AS923_CASE                                      \
	{                                               \
		return RegionAS923ChanMaskSet(chanMaskSet); \
	}
#define AS923_ADR_NEXT()                                                    \
	AS923_CASE                                                              \
	{                                                                       \
		return RegionAS923AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define AS923_RX_CONFIG()                               \
	AS923_CASE                                          \
	{                                                   \
		return RegionAS923RxConfig(rxConfig, datarate); \
	}
#define AS923_TX_CONFIG()                                           \
	AS923_CASE                                                      \
	{                                                               \
		return RegionAS923TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define AS923_LINK_ADR_REQ()                                                                \
	AS923_CASE                                                                              \
	{                                                                                       \
		return RegionAS923LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define AS923_RX_PARAM_SETUP_REQ()                          \
	AS923_CASE                                              \
	{                                                       \
		return RegionAS923RxParamSetupReq(rxParamSetupReq); \
	}
#define AS923_NEW_CHANNEL_REQ()                         \
	AS923_CASE                                          \
	{                                                   \
		return RegionAS923NewChannelReq(newChannelReq); \
	}
#define AS923_TX_PARAM_SETUP_REQ()                          \
	AS923_CASE                                              \
	{                                                       \
		return RegionAS923TxParamSetupReq(txParamSetupReq); \
	}
#define AS923_DL_CHANNEL_REQ()                        \
	AS923_CASE                                        \
	{                                                 \
		return RegionAS923DlChannelReq(dlChannelReq); \
	}
#define AS923_ALTERNATE_DR()                        \
	AS923_CASE                                      \
	{                                               \
		return RegionAS923AlternateDr(alternateDr); \
	}
...
#define AS923_NEXT_CHANNEL()                                                             \
	AS923_CASE                                                                           \
	{                                                                                    \
		return RegionAS923NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define AS923_CHANNEL_ADD()                       \
	AS923_CASE                                    \
	{                                             \
		return RegionAS923ChannelAdd(channelAdd); \
	}
#define AS923_CHANNEL_REMOVE()                           \
	AS923_CASE                                           \
	{                                                    \
		return RegionAS923ChannelsRemove(channelRemove); \
	}
...
#define AU915_GET_PHY_PARAM()                  \
	AU915_CASE                                 \
	{                                          \
		return RegionAU915GetPhyParam(getPhy); \
	}
...
#define AU915_VERIFY()                                  \
	AU915_CASE                                          \
	{                                                   \
		return RegionAU915Verify(verify, phyAttribute); \
	}
...
#define AU915_CHAN_MASK_SET()                       \
	AU915_CASE                                      \
	{                                               \
		return RegionAU915ChanMaskSet(chanMaskSet); \
	}
#define AU915_ADR_NEXT()                                                    \
	AU915_CASE                                                              \
	{                                                                       \
		return RegionAU915AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define AU915_RX_CONFIG()                               \
	AU915_CASE                                          \
	{                                                   \
		return RegionAU915RxConfig(rxConfig, datarate); \
	}
#define AU915_TX_CONFIG()                                           \
	AU915_CASE                                                      \
	{                                                               \
		return RegionAU915TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define AU915_LINK_ADR_REQ()                                                                \
	AU915_CASE                                                                              \
	{                                                                                       \
		return RegionAU915LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define AU915_RX_PARAM_SETUP_REQ()                          \
	AU915_CASE                                              \
	{                                                       \
		return RegionAU915RxParamSetupReq(rxParamSetupReq); \
	}
...
#define AU915_TX_PARAM_SETUP_REQ()                          \
	AU915_CASE                                              \
	{                                                       \
		return RegionAU915TxParamSetupReq(txParamSetupReq); \
	}
#define AU915_DL_CHANNEL_REQ()                        \
	AU915_CASE                                        \
	{                                                 \
		return RegionAU915DlChannelReq(dlChannelReq); \
	}
#define AU915_ALTERNATE_DR()                        \
	AU915_CASE                                      \
	{                                               \
		return RegionAU915AlternateDr(alternateDr); \
	}
...
#define AU915_NEXT_CHANNEL()                                                             \
	AU915_CASE                                                                           \
	{                                                                                    \
		return RegionAU915NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
...
#define AU915_CHANNEL_REMOVE()                           \
	AU915_CASE                                           \
	{                                                    \
		return RegionAU915ChannelsRemove(channelRemove); \
	}
...
#define CN470_GET_PHY_PARAM()                  \
	CN470_CASE                                 \
	{                                          \
		return RegionCN470GetPhyParam(getPhy); \
	}
...
#define CN470_VERIFY()                                  \
	CN470_CASE                                          \
	{                                                   \
		return RegionCN470Verify(verify, phyAttribute); \
	}
...
#define CN470_CHAN_MASK_SET()                       \
	CN470_CASE                                      \
	{                                               \
		return RegionCN470ChanMaskSet(chanMaskSet); \
	}
#define CN470_ADR_NEXT()                                                    \
	CN470_CASE                                                              \
	{                                                                       \
		return RegionCN470AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define CN470_RX_CONFIG()                               \
	CN470_CASE                                          \
	{                                                   \
		return RegionCN470RxConfig(rxConfig, datarate); \
	}
#define CN470_TX_CONFIG()                                           \
	CN470_CASE                                                      \
	{                                                               \
		return RegionCN470TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define CN470_LINK_ADR_REQ()                                                                \
	CN470_CASE                                                                              \
	{                                                                                       \
		return RegionCN470LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define CN470_RX_PARAM_SETUP_REQ()                          \
	CN470_CASE                                              \
	{                                                       \
		return RegionCN470RxParamSetupReq(rxParamSetupReq); \
	}
#define CN470_NEW_CHANNEL_REQ()                         \
	CN470_CASE                                          \
	{                                                   \
		return RegionCN470NewChannelReq(newChannelReq); \
	}
#define CN470_TX_PARAM_SETUP_REQ()                          \
	CN470_CASE                                              \
	{                                                       \
		return RegionCN470TxParamSetupReq(txParamSetupReq); \
	}
#define CN470_DL_CHANNEL_REQ()                        \
	CN470_CASE                                        \
	{                                                 \
		return RegionCN470DlChannelReq(dlChannelReq); \
	}
#define CN470_ALTERNATE_DR()                        \
	CN470_CASE                                      \
	{                                               \
		return RegionCN470AlternateDr(alternateDr); \
	}
...
#define CN470_NEXT_CHANNEL()                                                             \
	CN470_CASE                                                                           \
	{                                                                                    \
		return RegionCN470NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define CN470_CHANNEL_ADD()                       \
	CN470_CASE                                    \
	{                                             \
		return RegionCN470ChannelAdd(channelAdd); \
	}
#define CN470_CHANNEL_REMOVE()                           \
	CN470_CASE                                           \
	{                                                    \
		return RegionCN470ChannelsRemove(channelRemove); \
	}
...
#define CN779_GET_PHY_PARAM()                  \
	CN779_CASE                                 \
	{                                          \
		return RegionCN779GetPhyParam(getPhy); \
	}
...
#define CN779_VERIFY()                                  \
	CN779_CASE                                          \
	{                                                   \
		return RegionCN779Verify(verify, phyAttribute); \
	}
...
#define CN779_CHAN_MASK_SET()                       \
	CN779_CASE                                      \
	{                                               \
		return RegionCN779ChanMaskSet(chanMaskSet); \
	}
#define CN779_ADR_NEXT()                                                    \
	CN779_CASE                                                              \
	{                                                                       \
		return RegionCN779AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define CN779_RX_CONFIG()                               \
	CN779_CASE                                          \
	{                                                   \
		return RegionCN779RxConfig(rxConfig, datarate); \
	}
#define CN779_TX_CONFIG()                                           \
	CN779_CASE                                                      \
	{                                                               \
		return RegionCN779TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define CN779_LINK_ADR_REQ()                                                                \
	CN779_CASE                                                                              \
	{                                                                                       \
		return RegionCN779LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define CN779_RX_PARAM_SETUP_REQ()                          \
	CN779_CASE                                              \
	{                                                       \
		return RegionCN779RxParamSetupReq(rxParamSetupReq); \
	}
#define CN779_NEW_CHANNEL_REQ()                         \
	CN779_CASE                                          \
	{                                                   \
		return RegionCN779NewChannelReq(newChannelReq); \
	}
#define CN779_TX_PARAM_SETUP_REQ()                          \
	CN779_CASE                                              \
	{                                                       \
		return RegionCN779TxParamSetupReq(txParamSetupReq); \
	}
#define CN779_DL_CHANNEL_REQ()                        \
	CN779_CASE                                        \
	{                                                 \
		return RegionCN779DlChannelReq(dlChannelReq); \
	}
#define CN779_ALTERNATE_DR()                        \
	CN779_CASE                                      \
	{                                               \
		return RegionCN779AlternateDr(alternateDr); \
	}
...
#define CN779_NEXT_CHANNEL()                                                             \
	CN779_CASE                                                                           \
	{                                                                                    \
		return RegionCN779NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define CN779_CHANNEL_ADD()                       \
	CN779_CASE                                    \
	{                                             \
		return RegionCN779ChannelAdd(channelAdd); \
	}
#define CN779_CHANNEL_REMOVE()                           \
	CN779_CASE                                           \
	{                                                    \
		return RegionCN779ChannelsRemove(channelRemove); \
	}
...
#define EU433_GET_PHY_PARAM()                  \
	EU433_CASE                                 \
	{                                          \
		return RegionEU433GetPhyParam(getPhy); \
	}
...
#define EU433_VERIFY()                                  \
	EU433_CASE                                          \
	{                                                   \
		return RegionEU433Verify(verify, phyAttribute); \
	}
...
#define EU433_CHAN_MASK_SET()                       \
	EU433_CASE                                      \
	{                                               \
		return RegionEU433ChanMaskSet(chanMaskSet); \
	}
#define EU433_ADR_NEXT()                                                    \
	EU433_CASE                                                              \
	{                                                                       \
		return RegionEU433AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define EU433_RX_CONFIG()                               \
	EU433_CASE                                          \
	{                                                   \
		return RegionEU433RxConfig(rxConfig, datarate); \
	}
#define EU433_TX_CONFIG()                                           \
	EU433_CASE                                                      \
	{                                                               \
		return RegionEU433TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define EU433_LINK_ADR_REQ()                                                                \
	EU433_CASE                                                                              \
	{                                                                                       \
		return RegionEU433LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define EU433_RX_PARAM_SETUP_REQ()                          \
	EU433_CASE                                              \
	{                                                       \
		return RegionEU433RxParamSetupReq(rxParamSetupReq); \
	}
...
#define EU433_TX_PARAM_SETUP_REQ()                          \
	EU433_CASE                                              \
	{                                                       \
		return RegionEU433TxParamSetupReq(txParamSetupReq); \
	}
#define EU433_DL_CHANNEL_REQ()                        \
	EU433_CASE                                        \
	{                                                 \
		return RegionEU433DlChannelReq(dlChannelReq); \
	}
...
#define EU433_NEXT_CHANNEL()                                                             \
	EU433_CASE                                                                           \
	{                                                                                    \
		return RegionEU433NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define EU433_CHANNEL_ADD()                       \
	EU433_CASE                                    \
	{                                             \
		return RegionEU433ChannelAdd(channelAdd); \
	}
#define EU433_CHANNEL_REMOVE()                           \
	EU433_CASE                                           \
	{                                                    \
		return RegionEU433ChannelsRemove(channelRemove); \
	}
...
#define EU868_GET_PHY_PARAM()                  \
	EU868_CASE                                 \
	{                                          \
		return RegionEU868GetPhyParam(getPhy); \
	}
...
#define EU868_VERIFY()                                  \
	EU868_CASE                                          \
	{                                                   \
		return RegionEU868Verify(verify, phyAttribute); \
	}
...
#define EU868_CHAN_MASK_SET()                       \
	EU868_CASE                                      \
	{                                               \
		return RegionEU868ChanMaskSet(chanMaskSet); \
	}
#define EU868_ADR_NEXT()                                                    \
	EU868_CASE                                                              \
	{                                                                       \
		return RegionEU868AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define EU868_RX_CONFIG()                               \
	EU868_CASE                                          \
	{                                                   \
		return RegionEU868RxConfig(rxConfig, datarate); \
	}
#define EU868_TX_CONFIG()                                           \
	EU868_CASE                                                      \
	{                                                               \
		return RegionEU868TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define EU868_LINK_ADR_REQ()                                                                \
	EU868_CASE                                                                              \
	{                                                                                       \
		return RegionEU868LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define EU868_RX_PARAM_SETUP_REQ()                          \
	EU868_CASE                                              \
	{                                                       \
		return RegionEU868RxParamSetupReq(rxParamSetupReq); \
	}
#define EU868_NEW_CHANNEL_REQ()                         \
	EU868_CASE                                          \
	{                                                   \
		return RegionEU868NewChannelReq(newChannelReq); \
	}
#define EU868_TX_PARAM_SETUP_REQ()                          \
	EU868_CASE                                              \
	{                                                       \
		return RegionEU868TxParamSetupReq(txParamSetupReq); \
	}
#define EU868_DL_CHANNEL_REQ()                        \
	EU868_CASE                                        \
	{                                                 \
		return RegionEU868DlChannelReq(dlChannelReq); \
	}
#define EU868_ALTERNATE_DR()                        \
	EU868_CASE                                      \
	{                                               \
		return RegionEU868AlternateDr(alternateDr); \
	}
...
#define EU868_NEXT_CHANNEL()                                                             \
	EU868_CASE                                                                           \
	{                                                                                    \
		return RegionEU868NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define EU868_CHANNEL_ADD()                       \
	EU868_CASE                                    \
	{                                             \
		return RegionEU868ChannelAdd(channelAdd); \
	}
#define EU868_CHANNEL_REMOVE()                           \
	EU868_CASE                                           \
	{                                                    \
		return RegionEU868ChannelsRemove(channelRemove); \
	}
...
#define KR920_GET_PHY_PARAM()                  \
	KR920_CASE                                 \
	{                                          \
		return RegionKR920GetPhyParam(getPhy); \
	}
...
#define KR920_VERIFY()                                  \
	KR920_CASE                                          \
	{                                                   \
		return RegionKR920Verify(verify, phyAttribute); \
	}
...
#define KR920_CHAN_MASK_SET()                       \
	KR920_CASE                                      \
	{                                               \
		return RegionKR920ChanMaskSet(chanMaskSet); \
	}
#define KR920_ADR_NEXT()                                                    \
	KR920_CASE                                                              \
	{                                                                       \
		return RegionKR920AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define KR920_RX_CONFIG()                               \
	KR920_CASE                                          \
	{                                                   \
		return RegionKR920RxConfig(rxConfig, datarate); \
	}
#define KR920_TX_CONFIG()                                           \
	KR920_CASE                                                      \
	{                                                               \
		return RegionKR920TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define KR920_LINK_ADR_REQ()                                                                \
	KR920_CASE                                                                              \
	{                                                                                       \
		return RegionKR920LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define KR920_RX_PARAM_SETUP_REQ()                          \
	KR920_CASE                                              \
	{                                                       \
		return RegionKR920RxParamSetupReq(rxParamSetupReq); \
	}
#define KR920_NEW_CHANNEL_REQ()                         \
	KR920_CASE                                          \
	{                                                   \
		return RegionKR920NewChannelReq(newChannelReq); \
	}
#define KR920_TX_PARAM_SETUP_REQ()                          \
	KR920_CASE                                              \
	{                                                       \
		return RegionKR920TxParamSetupReq(txParamSetupReq); \
	}
#define KR920_DL_CHANNEL_REQ()                        \
	KR920_CASE                                        \
	{                                                 \
		return RegionKR920DlChannelReq(dlChannelReq); \
	}
#define KR920_ALTERNATE_DR()                        \
	KR920_CASE                                      \
	{                                               \
		return RegionKR920AlternateDr(alternateDr); \
	}
...
#define KR920_NEXT_CHANNEL()                                                             \
	KR920_CASE                                                                           \
	{                                                                                    \
		return RegionKR920NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define KR920_CHANNEL_ADD()                       \
	KR920_CASE                                    \
	{                                             \
		return RegionKR920ChannelAdd(channelAdd); \
	}
#define KR920_CHANNEL_REMOVE()                           \
	KR920_CASE                                           \
	{                                                    \
		return RegionKR920ChannelsRemove(channelRemove); \
	}
...
#define IN865_GET_PHY_PARAM()                  \
	IN865_CASE                                 \
	{                                          \
		return RegionIN865GetPhyParam(getPhy); \
	}
...
#define IN865_VERIFY()                                  \
	IN865_CASE                                          \
	{                                                   \
		return RegionIN865Verify(verify, phyAttribute); \
	}
...
#define IN865_CHAN_MASK_SET()                       \
	IN865_CASE                                      \
	{                                               \
		return RegionIN865ChanMaskSet(chanMaskSet); \
	}
#define IN865_ADR_NEXT()                                                    \
	IN865_CASE                                                              \
	{                                                                       \
		return RegionIN865AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define IN865_RX_CONFIG()                               \
	IN865_CASE                                          \
	{                                                   \
		return RegionIN865RxConfig(rxConfig, datarate); \
	}
#define IN865_TX_CONFIG()                                           \
	IN865_CASE                                                      \
	{                                                               \
		return RegionIN865TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define IN865_LINK_ADR_REQ()                                                                \
	IN865_CASE                                                                              \
	{                                                                                       \
		return RegionIN865LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define IN865_RX_PARAM_SETUP_REQ()                          \
	IN865_CASE                                              \
	{                                                       \
		return RegionIN865RxParamSetupReq(rxParamSetupReq); \
	}
#define IN865_NEW_CHANNEL_REQ()                         \
	IN865_CASE                                          \
	{                                                   \
		return RegionIN865NewChannelReq(newChannelReq); \
	}
#define IN865_TX_PARAM_SETUP_REQ()                          \
	IN865_CASE                                              \
	{                                                       \
		return RegionIN865TxParamSetupReq(txParamSetupReq); \
	}
#define IN865_DL_CHANNEL_REQ()                        \
	IN865_CASE                                        \
	{                                                 \
		return RegionIN865DlChannelReq(dlChannelReq); \
	}
#define IN865_ALTERNATE_DR()                        \
	IN865_CASE                                      \
	{                                               \
		return RegionIN865AlternateDr(alternateDr); \
	}
...
#define IN865_NEXT_CHANNEL()                                                             \
	IN865_CASE                                                                           \
	{                                                                                    \
		return RegionIN865NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define IN865_CHANNEL_ADD()                       \
	IN865_CASE                                    \
	{                                             \
		return RegionIN865ChannelAdd(channelAdd); \
	}
#define IN865_CHANNEL_REMOVE()                           \
	IN865_CASE                                           \
	{                                                    \
		return RegionIN865ChannelsRemove(channelRemove); \
	}
...
#define US915_GET_PHY_PARAM()                  \
	US915_CASE                                 \
	{                                          \
		return RegionUS915GetPhyParam(getPhy); \
	}
...
#define US915_VERIFY()                                  \
	US915_CASE                                          \
	{                                                   \
		return RegionUS915Verify(verify, phyAttribute); \
	}
...
#define US915_CHAN_MASK_SET()                       \
	US915_CASE                                      \
	{                                               \
		return RegionUS915ChanMaskSet(chanMaskSet); \
	}
#define US915_ADR_NEXT()                                                    \
	US915_CASE                                                              \
	{                                                                       \
		return RegionUS915AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define US915_RX_CONFIG()                               \
	US915_CASE                                          \
	{                                                   \
		return RegionUS915RxConfig(rxConfig, datarate); \
	}
#define US915_TX_CONFIG()                                           \
	US915_CASE                                                      \
	{                                                               \
		return RegionUS915TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define US915_LINK_ADR_REQ()                                                                \
	US915_CASE                                                                              \
	{                                                                                       \
		return RegionUS915LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define US915_RX_PARAM_SETUP_REQ()                          \
	US915_CASE                                              \
	{                                                       \
		return RegionUS915RxParamSetupReq(rxParamSetupReq); \
	}
#define US915_NEW_CHANNEL_REQ()                         \
	US915_CASE                                          \
	{                                                   \
		return RegionUS915NewChannelReq(newChannelReq); \
	}
#define US915_TX_PARAM_SETUP_REQ()                          \
	US915_CASE                                              \
	{                                                       \
		return RegionUS915TxParamSetupReq(txParamSetupReq); \
	}
#define US915_DL_CHANNEL_REQ()                        \
	US915_CASE                                        \
	{                                                 \
		return RegionUS915DlChannelReq(dlChannelReq); \
	}
#define US915_ALTERNATE_DR()                        \
	US915_CASE                                      \
	{                                               \
		return RegionUS915AlternateDr(alternateDr); \
	}
...
#define US915_NEXT_CHANNEL()                                                             \
	US915_CASE                                                                           \
	{                                                                                    \
		return RegionUS915NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define US915_CHANNEL_ADD()                       \
	US915_CASE                                    \
	{                                             \
		return RegionUS915ChannelAdd(channelAdd); \
	}
#define US915_CHANNEL_REMOVE()                           \
	US915_CASE                                           \
	{                                                    \
		return RegionUS915ChannelsRemove(channelRemove); \
	}
...
#define RU864_GET_PHY_PARAM()                  \
	RU864_CASE                                 \
	{                                          \
		return RegionRU864GetPhyParam(getPhy); \
	}
...
#define RU864_VERIFY()                                  \
	RU864_CASE                                          \
	{                                                   \
		return RegionRU864Verify(verify, phyAttribute); \
	}
...
#define RU864_CHAN_MASK_SET()                       \
	RU864_CASE                                      \
	{                                               \
		return RegionRU864ChanMaskSet(chanMaskSet); \
	}
#define RU864_ADR_NEXT()                                                    \
	RU864_CASE                                                              \
	{                                                                       \
		return RegionRU864AdrNext(adrNext, drOut, txPowOut, adrAckCounter); \
	}
...
#define RU864_RX_CONFIG()                               \
	RU864_CASE                                          \
	{                                                   \
		return RegionRU864RxConfig(rxConfig, datarate); \
	}
#define RU864_TX_CONFIG()                                           \
	RU864_CASE                                                      \
	{                                                               \
		return RegionRU864TxConfig(txConfig, txPower, txTimeOnAir); \
	}
#define RU864_LINK_ADR_REQ()                                                                \
	RU864_CASE                                                                              \
	{                                                                                       \
		return RegionRU864LinkAdrReq(linkAdrReq, drOut, txPowOut, nbRepOut, nbBytesParsed); \
	}
#define RU864_RX_PARAM_SETUP_REQ()                          \
	RU864_CASE                                              \
	{                                                       \
		return RegionRU864RxParamSetupReq(rxParamSetupReq); \
	}
#define RU864_NEW_CHANNEL_REQ()                         \
	RU864_CASE                                          \
	{                                                   \
		return RegionRU864NewChannelReq(newChannelReq); \
	}
#define RU864_TX_PARAM_SETUP_REQ()                          \
	RU864_CASE                                              \
	{                                                       \
		return RegionRU864TxParamSetupReq(txParamSetupReq); \
	}
#define RU864_DL_CHANNEL_REQ()                        \
	RU864_CASE                                        \
	{                                                 \
		return RegionRU864DlChannelReq(dlChannelReq); \
	}
#define RU864_ALTERNATE_DR()                        \
	RU864_CASE                                      \
	{                                               \
		return RegionRU864AlternateDr(alternateDr); \
	}
...
#define RU864_NEXT_CHANNEL()                                                             \
	RU864_CASE                                                                           \
	{                                                                                    \
		return RegionRU864NextChannel(nextChanParams, channel, time, aggregatedTimeOff); \
	}
#define RU864_CHANNEL_ADD()                       \
	RU864_CASE                                    \
	{                                             \
		return RegionRU864ChannelAdd(channelAdd); \
	}
#define RU864_CHANNEL_REMOVE()                           \
	RU864_CASE                                           \
	{                                                    \
		return RegionRU864ChannelsRemove(channelRemove); \
	}
